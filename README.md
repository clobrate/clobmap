...
> **Status:** Phase 10 / 15 — macOS code-signing + notarization + `.clobmap.yaml` file association wired in; double-clicking a clobmap file in Finder opens it in the running app via single-instance forwarding. Windows / Linux ship unsigned for now. Release runbook at [`RELEASING.md`](./RELEASING.md). Live at https://clobmap.com.
