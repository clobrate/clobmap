...
- Does _not_ use native UI widgets — it paints pixels itself.
...
- **Starting fresh on both** → Flutter is more _self-contained_. One language, one framework, one set of docs.
